    ...
    public class PauseMenu:Menu
    {
        ...
        public PauseMenu(ContentManager _con, List<string> _options, Vector2 _pos,Scene _scene) :base(_con, _options,_pos, _scene)
        {
            ...
            mapSects = new List<Vector2>(){
                ...
                new Vector2(_pos.X+20 + sectSize*9,_pos.Y+20 +sectSize*3),    //room 11
                ...
                new Vector2(_pos.X+20 + sectSize*5,_pos.Y+20 +sectSize*2),    //room 19
                new Vector2(_pos.X+20 + sectSize*5,_pos.Y+20 +sectSize*1),    //room 20
                new Vector2(_pos.X+20 + sectSize*6,_pos.Y+20 +sectSize*1),    //room 21
                ...
                new Vector2(_pos.X+20 + sectSize*3,_pos.Y+20 +sectSize*5),    //room 25
                new Vector2(_pos.X+20 + sectSize*2,_pos.Y+20 +sectSize*4),    //room 26
                new Vector2(_pos.X+20 + sectSize*2,_pos.Y+20 +sectSize*5),    //room 27
            };
            #endregion
        }
        public override void Update(GameTime _gt)
        {
            if (input.PauseInput) { scene.pause = !scene.pause; active = !active; }//if P is "pressed" pause the game 
